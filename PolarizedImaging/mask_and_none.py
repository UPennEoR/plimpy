...
os.system("casa -c \"exportfits(imagename={},fitsimage={}\"".format(mspath[:-1],impath+'kerndata.fits')

fitsheader = fits.open(impath+'kerndata.fits')[0].header
ra0, dec0 = header['RAJ2000'], header['DEJ2000']
